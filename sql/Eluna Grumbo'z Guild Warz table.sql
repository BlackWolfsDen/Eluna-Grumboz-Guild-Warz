...
REPLACE INTO `help` (`entry`, `name`, `description`, `example`, `command_level`) VALUES
	...
	(39, 'barrack_L', 'system setting limit how many barracks per location', 'set barrack_L 1', '6'),
	(40, 'hall_L', 'system setting limit how many halls per location', 'set hall_L 1', '6'),
	(41, 'pig_L', 'system setting limit how may pigs per location.', 'set pig_L 20', '6'),
	(42, 'guard_L', 'system setting limit how many guards per location.', 'set guard_L 10', '6'),
