...
REPLACE INTO `help` (`entry`, `name`, `description`, `example`, `command_level`) VALUES
	...
	(71, 'cannon', 'Word used to identify a guild cannon to support buy/sell.', 'set cannon gun', '4'),
	(72, 'cannon_cost', 'system setting how much x of currency to buy a cannon.', 'set cannon_cost 30', '6'),
	(73, 'cannon_L', 'system setting limit how many buff vendors per location.', 'set cannon_L 2', '6'),
