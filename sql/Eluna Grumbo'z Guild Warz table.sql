...
CREATE TABLE IF NOT EXISTS `zones` (
  ...
  `guild_name` char(50) NOT NULL DEFAULT 'SERVER',
  `team` tinyint(1) unsigned NOT NULL DEFAULT '2',
  `x` float NOT NULL DEFAULT '0',
  `y` float NOT NULL DEFAULT '0',
  `z` float NOT NULL DEFAULT '0',
  `farm_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `barrack_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `hall_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `pig_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `guard_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `vendor1_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `vendor2_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `vendor3_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `cannon_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `vault_count` bigint(20) unsigned NOT NULL DEFAULT '0',
  `mailbox_count` bigint(20) unsigned NOT NULL DEFAULT '0',
