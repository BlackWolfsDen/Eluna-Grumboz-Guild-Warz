...
CREATE TABLE IF NOT EXISTS `commands` (
  ...
  `vault` varchar(15) NOT NULL DEFAULT 'cannon',
  `vault_cost` smallint(5) unsigned NOT NULL DEFAULT '100',
  `vault_L` smallint(5) unsigned NOT NULL DEFAULT '3',
  `vault_id` mediumint(8) unsigned NOT NULL DEFAULT '49010' COMMENT 'Do Not Touch',
  `mailbox` varchar(15) NOT NULL DEFAULT 'cannon',
  `mailbox_cost` smallint(5) unsigned NOT NULL DEFAULT '100',
  `mailbox_L` smallint(5) unsigned NOT NULL DEFAULT '3',
  `mailbox_id` mediumint(8) unsigned NOT NULL DEFAULT '49010' COMMENT 'Do Not Touch',
...
('SERVER', 'commands', 'info', 'list', 'gtele', 'ver', 0, 0, 'flag', 'loc', 'table', 5, 4, 62006, 100000, 1800000, 25, 0, 'SERVER', 'set', 1, 0, 300, 0, 0, 'area', 10, 187432, 'farm', 5, 1, 500000, 'barrack', 10, 1, 500002, 'hall', 100, 1, 500004, 'pig', 1, 20, 49000, 'guard', 1, 10, 49002, 'vendor1', 25, 1, 49004, 'vendor2', 25, 1, 49006, 'vendor3', 25, 1, 49008, 'cannon', 100, 3, 49010, 'cannon', 100, 1, 49010, 'cannon', 10, 1, 49010, '|cff00cc00', '|cffFFFF00', '|cffFFFFFF', '|cff3399FF', '|cffFF0000', '|cffFFFF00', '|cffFF0000', '|cffC0C0C0', '|cff000000', '|cff00cc00', '|cffFFFF00', '|cffFF0000', '|cffFFFFFF', '|cff00cc00', '|cffFF0000');
