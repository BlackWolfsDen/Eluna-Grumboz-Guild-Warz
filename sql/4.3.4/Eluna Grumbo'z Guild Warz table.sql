...
-- Dumping database structure for guild_warz_434
CREATE DATABASE IF NOT EXISTS `guild_warz_434` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `guild_warz_434`;


-- Dumping structure for table guild_warz_434.commands
CREATE TABLE IF NOT EXISTS `commands` (
  ...
  `currency` bigint(20) unsigned NOT NULL DEFAULT '620006' COMMENT 'item id for currency used.',
  ...
  `pig_id` mediumint(8) NOT NULL DEFAULT '69000' COMMENT 'Do Not Touch',
  `guard_id` mediumint(8) NOT NULL DEFAULT '69002' COMMENT 'Do Not Touch',
...
-- Dumping data for table guild_warz_434.commands: ~2 rows (approximately)
...
REPLACE INTO `commands` (`guild`, `commands`, `info_loc`, `list_loc`, `tele`, `version`, `loc`, `farm`, `barrack`, `hall`, `pig`, `guard`, `GLD_lvlb`, `GLD_lvls`, `respawn_flag`, `details_loc`, `table`, `GM_admin`, `GM_minimum`, `currency`, `loc_cost`, `farm_cost`, `barrack_cost`, `hall_cost`, `pig_cost`, `guard_cost`, `farm_L`, `barrack_L`, `hall_L`, `pig_L`, `guard_L`, `pig_payz`, `pig_payz_timer`, `gift_count`, `flag_require`, `Server`, `flag_id`, `farm_id`, `barrack_id`, `hall_id`, `pig_id`, `guard_id`, `x1`, `x2`, `x3`, `command_set`, `anarchy`, `f_timer`, `s_timer`, `guild_id`, `guild_invite`) VALUES
	('SERVER', 'commands', 'info', 'list', 'gtele', 'ver', 'area', 'farm', 'barrack', 'hall', 'pig', 'guard', 0, 0, 'flag', 'loc', 'table', 5, 4, 620006, 10, 5, 10, 100, 1, 1, 1, 1, 1, 20, 10, 100000, 1800000, 25, 0, 'SERVER', 187432, 500000, 500002, 500004, 69000, 69002, 1, 1, 1, 'set', 1, 1, 300, 0, 0);
/*!40000 ALTER TABLE `commands` ENABLE KEYS */;


-- Dumping structure for table guild_warz_434.help
...
-- Dumping data for table guild_warz_434.help: ~60 rows (approximately)
...
-- Dumping structure for table guild_warz_434.zones
...
-- Dumping data for table guild_warz_434.zones: ~3 rows (approximately)
