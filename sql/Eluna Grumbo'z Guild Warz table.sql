...
CREATE TABLE IF NOT EXISTS `commands` (
  ...
  `vault_id` mediumint(8) unsigned NOT NULL DEFAULT '500008' COMMENT 'Do Not Touch',
  ...
  `mailbox_id` mediumint(8) unsigned NOT NULL DEFAULT '500010' COMMENT 'Do Not Touch',
